...
public class MqttConfig {
    ...
    private static final String MQTT_BROKER_URL = "tcp://localhost:1883"; // Your broker URL
    private static final String MQTT_CLIENT_ID = "spring-boot-publisher"; // Client identifier
